...
Chat Interface with multi-session support, provider and model selection, streamed markdown responses, local-time conversation dates, a subtle AI thinking indicator, and image loading states.

Analytics Dashboard with timezone-aware date-range and provider filters showing request metrics, throughput, latency, comparisons, and error logs.
